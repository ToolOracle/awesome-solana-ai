...
- [SolanaOracle](https://github.com/ToolOracle/solanaoracle) - 12 MCP tools for DeFi risk & compliance intelligence on Solana, including SPL token risk scoring with mint/freeze authority checks, protocol health, DeFi yields, stablecoin risk, wallet analysis, DEX volume, validator info, and network stats ([live remote server](https://tooloracle.io/solana/mcp/)).
